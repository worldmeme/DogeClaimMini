      ...
      <Page>
        <Page.Main className="flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-purple-900 to-blue-900">
          <div className="flex items-center justify-center">
            <svg
              className="animate-spin h-10 w-10 md:h-12 md:w-12 lg:h-16 lg:w-16 text-gray-300"
            ...
            <p className="ml-4 text-gray-300 text-lg md:text-xl lg:text-2xl animate-pulse">Loading...</p>
          </div>
        </Page.Main>
      </Page>
    );
    ...
    return (
      <Page>
        <Page.Main className="flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-purple-900 to-blue-900 text-white font-sans">
          ...
          <p className="text-base md:text-lg lg:text-xl text-gray-300 mt-2 animate-fade-in">Each human can claim DCMINI tokens every 7 days.</p>
